...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <?php include 'navbar.php'; ?>
   ...
   <?php echo form_open("editpostback/".$record[0]->ID); ?>
     ...
     <input class="form-control" type="text" size="20" id="surname" name="surname" value="<?php echo $record[0]->Surname?>"/>
     <br/>
	 <label for="age">Age:</label><br/>
     <input class="form-control" type="text" size="3" id="age" name="age" value="<?php echo $record[0]->Age?>"/>
     <br/>
